module spi_driver (
    ...
    output [7:0] ascii_X1, ascii_X2, ascii_X3, ascii_X4, ascii_X5, ascii_X6,
    output [7:0] ascii_Y1, ascii_Y2, ascii_Y3, ascii_Y4, ascii_Y5, ascii_Y6,
    output [7:0] ascii_Z1, ascii_Z2, ascii_Z3, ascii_Z4, ascii_Z5, ascii_Z6,
    ...
    reg [11:0] raw_X, raw_Y, raw_Z;
    reg [11:0] raw_T;
    reg softRstWaitEn;
    reg [15:0] softRstWaitTimer;
    reg convert_to_ascii;

    wire [16:0] binary_X, binary_Y, binary_Z;
    wire [16:0] binary_T;
    ...
    assign ascii_X1 = ascii_X[47:40]; //assumes most significant bit is sent first
    assign ascii_X2 = ascii_X[39:32];    
    assign ascii_X3 = ascii_X[31:24];
    assign ascii_X4 = ascii_X[23:16];
    assign ascii_X5 = ascii_X[15:8];
    assign ascii_X6 = ascii_X[7:0];

    binary_to_ascii binary_to_ascii_Y(
        .bin(binary_Y),
        .ascii(ascii_Y)
    );
    assign ascii_Y1 = ascii_Y[47:40]; //assumes most significant bit is sent first
    assign ascii_Y2 = ascii_Y[39:32];    
    assign ascii_Y3 = ascii_Y[31:24];
    assign ascii_Y4 = ascii_Y[23:16];
    assign ascii_Y5 = ascii_Y[15:8];
    assign ascii_Y6 = ascii_Y[7:0];

    binary_to_ascii binary_to_ascii_Z(
        .bin(binary_Z),
        .ascii(ascii_Z)
    );
    assign ascii_Z1 = ascii_T[47:40]; //assumes most significant bit is sent first
    assign ascii_Z2 = ascii_T[39:32];    
    assign ascii_Z3 = ascii_Z[31:24];
    assign ascii_Z4 = ascii_Z[23:16];
    assign ascii_Z5 = ascii_Z[15:8];
    assign ascii_Z6 = ascii_Z[7:0];
